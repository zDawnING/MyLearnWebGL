 ...
 */
export const Object = function(name) {
  this.name = name;
...
// 材质
//------------------------------------------------------------------------------
const Material = function(name, r, g, b, a) {
  this.name = name;
...
// 面
//------------------------------------------------------------------------------
const Face = function(materialName) {
...
// 绘制数据对象
//------------------------------------------------------------------------------
const DrawingInfo = function(vertices, normals, colors, indices) {
 ...
 */
export const ObjDoc = function(fileName){
 ...
 */
export const StringParse = function(str){
	this.str; // 将参数字符串保存下来
	this.index; // 当前处理位置
	this.init(str);
}
